...
class ScraperService {
  ...
  async fetchPageContent(url) {
    try {
      ...
      // Clean up Twitter handles (remove @ if present)
      const cleanTwitterHandle = (handle) => {
      ...
      return {
        ...
        tags: tags,
        url: url,
        twitter_creator: cleanTwitterHandle(twitterCreator),
        twitter_site: cleanTwitterHandle(twitterSite)
      };
    } catch (error) {
