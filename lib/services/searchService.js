        ...
        query: {
          bool: {
            should: [
              ...
              // Prefix/wildcard matching for partial name matches
              {
                wildcard: {
                  name: {
                    value: `*${query.toLowerCase()}*`,
                    boost: keywordWeight * 0.8 // Slightly lower boost than exact matches
                  }
                }
              },
              // Prefix/wildcard matching for tags
              {
                wildcard: {
                  tags: {
                    value: `*${query.toLowerCase()}*`,
                    boost: keywordWeight * 0.6
                  }
                }
              }
            ],
